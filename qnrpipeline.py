...
#   cdbfasta / cdbyank
#
# This file is the main component of the
# qnr-search pipeline that searches databases
# using HMMER to find sequences matching a
# Hidden Markov Model. These sequences are then 
# clustered and aligned against each other to 
# simplify identification of new gene variants 
# and maybe even new genes entirely.
#
